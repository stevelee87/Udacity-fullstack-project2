...
Item3 = Item(title="Iron Man Macbook Pro 15 inches cover",
             description="Bring Tony Stark and his awesome suit with you\
                         wherever you go with this cover for Macbook Pro\
                         15 inches.",
             cat_id=1, user_id=1)
...
Item1 = Item(title="Darth Vader key ring",
             description="Show off to your friends with the coolest key\
                         ring ever.",
             cat_id=2, user_id=1)
...
Item2 = Item(title="Iron man mini figure",
             description="Do you ever want to have Iron man's suit? How\
                         about this mini figure? It is handcrafted by\
                         Sebastian Schulmann and it weights 117g.",
             cat_id=2, user_id=1)
